...
export const computeContainerDimensionForBoundText = (
  ...
  if (containerType === "diamond" || containerType === "heart") {
...
export const getBoundTextMaxWidth = (
  ...
  if (container.type === "diamond" || container.type === "heart") {
    // Keep bound text inside the narrower middle of non-rectangular containers.
